...
module.exports = function (app) {
    ...
    app.put('/groups/:groupid(\\d+)/egroup/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
    ...
    app.delete('/groups/:groupid(\\d+)/duser/:userid(\\d+)/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
