...
module.exports = function (app) {
    ...
    app.put('/groups/:groupid(\\d+)/elistitem/:itemid(\\d+)/',[auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
    ...
    app.delete('/groups/:groupid(\\d+)/dlistitem/:itemid(\\d+)/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
    ...
    app.put('/groups/:groupid(\\d+)/elist/:listid(\\d+)/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
    ...
    app.delete('/groups/:groupid(\\d+)/dlist/:listid(\\d+)/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
