...
var router = require('express').Router();
    ...
    router.post('/groups/:groupid(\\d+)/messagetopic/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
        //Get a connection
    ...
    router.get('/groups/:groupid(\\d+)/messagetopic/', [auth.CheckAuthToken, auth.CheckInGroup], function (req, res) {
        //Get a connection
        //var con = mysql.createConnection(config.connectionInfo);
